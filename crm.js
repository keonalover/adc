    ...
    function buildAIUserPrompt(lead, sequenceKey) {
      ...
      const baseFacts = [
        greetingName
          ...
          : "No greeting target available — skip the personal opener line entirely and open the email with the first sentence of the body.",
        contactIsValid ? "" : greetingName ? "(No contact name — greeting target is the business name, use it as-is.)" : "",
        `Company: ${co}`,
